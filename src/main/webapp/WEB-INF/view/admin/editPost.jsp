  ...
  <div id="container" class="opacity"> 
    ...
    <div class="blog-post"> 
      ...
      <div class="full-width"> 
        <form action="<c:url value="/admin/post/editPostById.action"/>" method="post">
        <!-- Begin Post -->
        <div class="post"> 
          ...
          <div class="post-info"> 
            <!-- Begin Date -->
            <div class="post-date"> <span class="day">编</span> <span class="month">辑</span> <span class="years">文章</span></div>
            <!-- End Date --> 
            <!-- Begin Title -->
            <div style="width: 500px;display: inline-block;margin-left: 50px;position: relative; top:-20px;">
              <h1>
              	<input type="text" name="ptitle" class="form-control" value="${post.ptitle }" placeholder="文章标题" style="margin: 10px 0;">
              	...
              	<span  style=" display: inline-block;">
              		标签：
              			<c:forEach items="${post.tagList }" var="tag">
	              			<input class="tagids" type="hidden" name="oldtagids" value="${tag.tid }">
              			</c:forEach>
              			<c:forEach items="${tagList }" var="tag">
		              		${tag.tname }<input name="tids" id="${tag.tid }" value="${tag.tid }"   type="checkbox">&nbsp;
              			</c:forEach>
              	</span>
              </div>
            </div>
          ...
          <div class="post-text"> <!-- <img style="margin: 0 auto;" src="style/images/art/post1.jpg" alt="" /> --> <br />
        ...
        KindEditor.ready(function(K) {
            ...
            htmlTags: {
                ...
                div : [
                        ...
                        '.font-style', '.text-decoration', '.vertical-align', '.margin-left','.margin-bottom'
                ],
                table: [
                ...
                'p,ol,ul,li,blockquote,h1,h2,h3,h4,h5,h6' : [
                        ...
                        '.font-weight', '.font-style', '.text-decoration', '.vertical-align', '.text-indent', '.margin-left','.margin','.margin-bottom'
                ],
                pre : ['class'],
